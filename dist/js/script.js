...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.plus').forEach(function (el) {
    el.addEventListener('click', function (e) {
      var count = e.target.parentNode.querySelector('span');
  ...
  removeSlides();
  showSlide(0); //CAROUSEL FOR MARKET

  var marketContainer = document.querySelectorAll('.market__container');
  marketContainer.forEach(function (cont) {
    var btns = cont.querySelectorAll('.market__bullets-arrow'),
    ...
    function dotShows(n) {
      cont.querySelectorAll('.market__bullets span').forEach(function (el) {
        el.classList.remove('active');
      });
